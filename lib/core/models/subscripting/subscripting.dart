...
class AppSubscripting {
  static const _log = Log('AppSubscripting');
  ...
  static String getMathsExpression(String str) {
    switch (str) {
      case 't/m^3':
        return '[${const Localized('t/m').v}${getSuperscript('3')}]';
      case 't/s^-2':
        return '[${const Localized('t/s').v}${getSuperscript('-2')}]';
      default:
