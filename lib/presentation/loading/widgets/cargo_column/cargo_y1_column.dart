...
///
/// Creates [TableColumn] for [Cargo] y1.
class CargoY1Column implements TableColumn<Cargo, double?> {
  ...
  ///   [buildRecord] build [ValueRecord] for [Cargo] y1 field.
  const CargoY1Column({
  ...
  //
  @override
  String get name => '${const Localized('y1').v} [${const Localized('m').v}]';
  //
  @override
