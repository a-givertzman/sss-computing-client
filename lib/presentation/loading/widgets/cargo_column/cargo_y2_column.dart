...
///
/// Creates [TableColumn] for [Cargo] y2.
class CargoY2Column implements TableColumn<Cargo, double?> {
  ...
  ///   [buildRecord] build [ValueRecord] for [Cargo] y2 field.
  const CargoY2Column({
  ...
  //
  @override
  String get name => '${const Localized('y2').v} [${const Localized('m').v}]';
  //
  @override
