...
///
class OtherStoresCargoForm extends StatefulWidget {
  ...
  //
  @override
  State<OtherStoresCargoForm> createState() => _OtherStoresCargoFormState();
}
class _OtherStoresCargoFormState extends State<OtherStoresCargoForm> {
