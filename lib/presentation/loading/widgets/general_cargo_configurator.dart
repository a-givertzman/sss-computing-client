...
import 'package:sss_computing_client/presentation/general_cargo/general_cargo_page.dart';
import 'package:sss_computing_client/presentation/loading/widgets/cargo_column/cargo_is_on_deck_column.dart';
import 'package:sss_computing_client/presentation/loading/widgets/cargo_column/cargo_is_timber_column.dart';
...
///
/// Configurator for ship general cargo.
class GeneralCargoConfigurator extends StatefulWidget {
  ...
  ///
  /// Creates configurator for ship general cargo.
  ///
  ...
  const GeneralCargoConfigurator({
    super.key,
  ...
  //
  @override
  State<GeneralCargoConfigurator> createState() =>
      _GeneralCargoConfiguratorState();
}
class _GeneralCargoConfiguratorState extends State<GeneralCargoConfigurator> {
            ...
            child: EditingTable<Cargo>(
              ...
              columns: [
                ...
                CargoIsOnDeckColumn(
                  ...
                  buildRecord: (cargo, toValue) => FieldRecord<bool>(
                    dbName: widget._dbName,
                    apiAddress: ApiAddress(
                      host: widget._apiAddress.host,
                      port: widget._apiAddress.port,
  ...
  void _handleCargoAdd() {
    ...
    navigator.push(
      MaterialPageRoute(
        builder: (context) => GeneralCargoPage(
          label: const Localized('GeneralCargo').v,
  ...
  void _handleCargoEdit(Cargo cargo) {
    ...
    navigator.push(
      MaterialPageRoute(
        builder: (context) => GeneralCargoPage(
          label: const Localized('General cargo').v,
          cargo: cargo,
          fetchData: true,
          onClose: () {
            navigator.pop();
